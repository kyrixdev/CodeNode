...
<head>
    ...
    <title>Legal Information | CodeNode</title>
...
<body>
    <header>
        ...
        <div class="container aboutus text-center">
            ...
            <h1 class="text-light ">Legal Information</h1>
        </div>
        </div>
        </div>
    </header>

<section class="legals py-5">
<ul class="nav nav-pills mb-3 sidebar" id="pills-tab" role="tablist">
  <li class="nav-item" role="presentation">
    <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Terms of Services</button>
  </li>
  <li class="nav-item" role="presentation">
    <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Privacy Policy</button>
  </li>
</ul>
