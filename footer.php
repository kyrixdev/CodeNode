  ...
  <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5">
    ...
    <div class="col mb-3">
      ...
      <ul class="nav flex-column">
        ...
        <li class="nav-item mb-2"><a href="terms" class="nav-link p-0 text-body-secondary">Privacy Policy</a></li>
    ...
    <div class="col mb-3">
      ...
      <ul class="nav flex-column">
        ...
        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Counter-Strike 2 <span class="soon-product">SOON</span></a></li>
      </ul>
    </div>
...
window.$crisp = [];
window.CRISP_WEBSITE_ID = "22b068e5-352b-4a08-aad3-e4bb97ae7ab9";
(function() {
    d = document;
