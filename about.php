...
<head>
    ...
    <title>About Us | Easy Hosting, Powerful Performance</title>
...
<div class="container">
               ...
               <div class="row g-lg-7 gy-5">
                  <div class="col-lg-4 col-md-4">
                     ...
                     <h4>Our Mission</h4>
                     <p class="mb-0">At CodeNode, our mission is simple: to provide gamers with reliable, affordable, and top-notch hosting services. We're committed to delivering unparalleled customer support and ensuring that your Minecraft server runs smoothly 24/7.</p>
                  </div>
                  <div class="col-lg-4 col-md-4">
                     <div class="mb-5">
...
<div class="container content-space-2 content-space-lg-3">
      ...
      <small class="text-uppercase ls-md fw-semibold">our team</small>
        <h2 class="text-light fw-bold text-uppercase">Creative minds</h2>
      </div>
      <!-- End Heading -->
        ...
        <div class="col-sm-6 col-lg-3 mb-3">
          ...
          <div class="card card-transition h-100">
            <div class="card-body">
              ...
              <h4 class="card-title">Antoni Parys</h4>
      ...
      <!-- Card Info -->
      <div class="text-center hiring-card">
        <div class="position card-info-link card-sm w-fit mx-auto">
